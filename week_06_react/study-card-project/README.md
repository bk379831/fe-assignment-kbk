# 오늘의 공부 추천하기 컴포넌트 프로젝트

React 컴포넌트와 CSS 스타일링을 활용하여  
“오늘의 공부 추천하기” UI를 제작한 프로젝트입니다.

이번 프로젝트에서는 React의 컴포넌트 구조, props 전달, JSX 문법, CSS 모듈화 등을 중심으로 학습하였습니다.
...
- props를 사용해 데이터 전달하기
- 컴포넌트별 CSS 분리하기
- 반복적인 UI를 재사용 가능한 구조로 만들기
- 유지보수하기 좋은 파일 구조 경험하기
